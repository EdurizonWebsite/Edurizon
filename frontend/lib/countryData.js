...
const RussiaData={
    ...
    russiaReasonsToStudySection:[
        ...
        {universityName:"National Research Nuclear University, MEPHI",location:"Moscow",annualFees:"5,10,000-6,57,360 RUB/year",href:"/study-destinations/study-mbbs-in-russia/mephi", highlights:["National Research University status with advanced labs and simulation centers.","Medical training across Moscow main campus and Obninsk medical campus."]},
        {universityName:"Kemerovo State University",location:"Kemerovo",annualFees:"Contact Us",href:"/study-destinations/study-mbbs-in-russia/kemorovo-state-university", highlights:["Flagship public university with affordable MBBS pathway and strong academic base.","Student-friendly city environment with low living cost and broad international exposure."]},
        {universityName:"Kemerovo State Medical University",location:"Kemerovo",annualFees:"Contact Us",href:"/study-destinations/study-mbbs-in-russia/kemorovo-state-medical-university", highlights:["Recognized MBBS program (WHO, NMC, ECFMG) with practical hospital training.","Budget-friendly option for Indian students with secure hostel and supportive campus life."]},
        {universityName:"Chuvash State University",location:"Cheboksary",annualFees:"Contact Us",href:"/study-destinations/study-mbbs-in-russia/chuvash-state-university", highlights:["Recognized MBBS program (WHO, NMC, ECFMG) with practical hospital training.","Budget-friendly option for Indian students with secure hostel and supportive campus life."]},
