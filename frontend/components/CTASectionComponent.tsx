  ...
  return (
    <>
              ...
              <div id="freeConsultation" className={`${isHidden ?  "opacity-0 z-[-10]" : "opacity-100 z-[10]"} text-black  fixed   bottom-[5vh] w-full px-[4vw]  transition-all duration-100  pointer-events-none`} ref={freeConsultationRef}>
                ...
                <svg onClick={()=>setShowChatBot(!showChatBot)} className="bg-white overflow-visible rounded-full w-[10vw] h-[10vw] md:w-[2.5vw] md:h-[2.5vw]  pointer-events-auto cursor-pointer mt-auto " viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
